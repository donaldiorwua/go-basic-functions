...
func main() {
	...
	fmt.Println(gobasicfunctions.ArticleCorrection("There is a 'apple', there is an house"))
	...
	// fmt.Println(gobasicfunctions.BaseConversionCommand([]string{"hello", "welcome", "(up)", "world"}))
	// fmt.Println(gobasicfunctions.BaseConversionCommand([]string{"hello", "weLCome", "(cap)", "world"}))
	// fmt.Println(gobasicfunctions.BaseConversionCommand([]string{"hello", "WELCOME", "(low)", "world"}))
